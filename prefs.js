...
user_pref(
  ...
  '{"Format@euclpts.com":"838a4b75-aad7-4bd8-bdc9-8751a5df3772","Normalize@euclpts.com":"ac2e523e-c181-4949-9718-64d9105c7174"}',
);
...
user_pref(
  ...
  '{"zotero-reader-sidebar-pane":{"collapsed":"true"},"zotero-layout-switcher":{"orient":"horizontal"},"zotero-items-splitter":{"orient":"horizontal"},"zotero-item-pane":{"width":"337","height":"205"},"zotero-context-splitter":{"state":"collapsed"},"zotero-context-splitter-stacked":{"state":"collapsed"}}',
);
user_pref("extensions.zotero.panes.Format\\@euclpts\\.com-example.open", true);
user_pref(
  "extensions.zotero.panes.Format\\@euclpts\\.com-reader-example.open",
  true,
);
user_pref(
  "extensions.zotero.panes.Normalize\\@euclpts\\.com-example.open",
  true,
);
user_pref(
  "extensions.zotero.panes.Normalize\\@euclpts\\.com-reader-example.open",
  true,
);
...
user_pref(
  ...
  '{"L1":true,"C22":true,"P1":false,"L2":true,"L3":true,"L4":true,"L5":true,"L6":true,"C172":true}',
);
